...
public class GradleInit {
    public static String createInitProbe() {
        ...
        gradleInit.appendLine(2, String.format("classpath \"com.srdjanv:local-git-dependency:%s\"", Constants.PROJECT_VERSION));
        gradleInit.appendLine(1, "}");
    ...
    static class Plugins {
        ...
        private static final String modelInjection = "apply plugin: com.srdjanv.localgitdependency.injection.plugin.ModelInjectionPlugin";
